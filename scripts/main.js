...
window.DOMElementHandler = class extends DOMHandler {
    constructor(a, b) {
        ...
        this.AddRuntimeMessageHandler("set-visible", (a) => this._OnSetVisible(a)),
        this.AddRuntimeMessageHandler("update-position", (a) => this._OnUpdatePosition(a)),
        this.AddRuntimeMessageHandler("update-state", (a) => this._OnUpdateState(a)),
        this.AddRuntimeMessageHandler("focus", (a) => this._OnSetFocus(a)),
        this.AddRuntimeMessageHandler("set-css-style", (a) => this._OnSetCssStyle(a))
    }
    SetAutoAttach(a) {
        this._autoAttach = !!a
    }
...
"use strict";
{
    ...
    window.RuntimeInterface = class f {
        constructor(a) {
            ...
            d(this._exportType) && this._useWorker && (console.warn("[C3 runtime] Worker mode is enabled and supported, but is disabled in WebViews due to crbug.com/923007. Reverting to DOM mode."),
            this._useWorker = !1),
            ...
            this.AddRuntimeComponentMessageHandler("runtime", "cordova-fetch-local-file", (a) => this._OnCordovaFetchLocalFile(a)),
            this.AddRuntimeComponentMessageHandler("runtime", "create-job-worker", (a) => this._OnCreateJobWorker(a)),
            "cordova" === this._exportType ? document.addEventListener("deviceready", () => this._Init(a)) : this._Init(a)
        }
        Release() {
        ...
        async _Init(a) {
            ...
            this._messageChannelPort.onmessage = (a) => this["_OnMessageFromRuntime"](a.data),
            window["c3_addPortMessageHandler"] && window["c3_addPortMessageHandler"]( (a) => this._OnMessageFromDebugger(a)),
            ...
            this._useWorker ? await this._InitWorker(a, b.port2) : await this._InitDOM(a, b.port2)
        }
        _GetWorkerURL(a) {
        ...
        async _InitWorker(a, b) {
            ...
            self["c3_callFunction"] = (a, b) => this._runtimeDomHandler._InvokeFunctionFromJS(a, b),
        ...
        async _InitDOM(b, c) {
            ...
            if (Array.isArray(b.workerDependencyScripts) && d.unshift(...b.workerDependencyScripts),
            await Promise.all(d.map( (b) => a(b))),
            b.projectScripts && 0 < b.projectScripts.length) {
                const c = self["C3_ProjectScriptsStatus"];
                try {
                    if (await Promise.all(b.projectScripts.map( (b) => a(b[1]))),
                    Object.values(c).some( (a) => !a))
                        return void self.setTimeout( () => this._ReportProjectScriptError(c), 100)
                } catch (a) {
                    return console.error("[Preview] Error loading project scripts: ", a),
        ...
        ["_OnMessageFromRuntime"](a) {
            const b = a["type"];
            if ("event" === b)
                this._OnEventFromRuntime(a);
            else if ("result" === b)
                this._OnResultFromRuntime(a);
            else if ("runtime-ready" === b)
                this._OnRuntimeReady();
            else if ("alert" === b)
                alert(a["message"]);
            else
                throw new Error(`unknown message '${b}'`)
        }
        _OnEventFromRuntime(a) {
            const b = a["component"]
              ...
              , f = k.get(b);
            if (!f)
                return void console.warn(`[DOM] No event handlers for component '${b}'`);
            const g = f.get(c);
            if (!g)
                return void console.warn(`[DOM] No handler '${c}' for component '${b}'`);
            let h = null;
            try {
                h = g(d)
            } catch (a) {
                return console.error(`Exception in '${b}' handler '${c}':`, a),
        ...
        _OnRAFCallback() {
            this._rafId = -1;
            for (const a of this._rafCallbacks)
                a();
            this._RequestAnimationFrame()
        }
        TryPlayMedia(a) {
        ...
        async _ConvertDataUriToBlobs(a, b) {
            if ("object" == typeof b)
                this._localFileBlobs[a] = new Blob([b["str"]],{
                    "type": b["type"]
                }),
        ...
        async _FetchDataUri(a) {
            try {
                ...
                return console.warn("Failed to fetch a data: URI. Falling back to a slower workaround. This is probably because the Content Security Policy unnecessarily blocked it. Allow data: URIs in your CSP to avoid this.", a),
                null
            }
        }
        ...
        _BinaryStringToBlob(a, b) {
            let c, d, e = a.length, f = e >> 2, g = new Uint8Array(e), h = new Uint32Array(g.buffer,0,f);
            for (c = 0,
            d = 0; c < f; ++c)
                h[c] = a.charCodeAt(d++) | a.charCodeAt(d++) << 8 | a.charCodeAt(d++) << 16 | a.charCodeAt(d++) << 24;
            for (let c = 3 & e; c--; )
                g[d] = a.charCodeAt(d),
                ++d;
            return new Blob([g],{
        ...
        _TestTransferablesWork() {
            ...
            return d.port2.onmessage = (b) => {
                b.data && b.data["arrayBuffer"] || (this._transferablesBroken = !0,
...
"use strict";
{
    ...
    async function f(a, b, c) {
        ...
        i.setAttribute("width", b + "px"),
        i.setAttribute("height", c + "px");
        const j = new XMLSerializer;
        return f = j.serializeToString(h),
        a = new Blob([f],{
            type: "image/svg+xml"
        }),
        await d(a)
    ...
    const l = new Map([["OSLeft", "MetaLeft"], ["OSRight", "MetaRight"]])
      , m = {
    ...
    const r = class extends DOMHandler {
        constructor(a) {
            ...
            a.AddRuntimeComponentMessageHandler("canvas", "update-size", (a) => this._OnUpdateCanvasSize(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "invoke-download", (a) => this._OnInvokeDownload(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "raster-svg-image", (a) => this._OnRasterSvgImage(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "get-svg-image-size", (a) => this._OnGetSvgImageSize(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "set-target-orientation", (a) => this._OnSetTargetOrientation(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "register-sw", () => this._OnRegisterSW()),
            a.AddRuntimeComponentMessageHandler("runtime", "post-to-debugger", (a) => this._OnPostToDebugger(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "go-to-script", (a) => this._OnPostToDebugger(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "before-start-ticking", () => this._OnBeforeStartTicking()),
            a.AddRuntimeComponentMessageHandler("runtime", "debug-highlight", (a) => this._OnDebugHighlight(a)),
            ...
            a.AddRuntimeComponentMessageHandler("runtime", "add-stylesheet", (a) => this._OnAddStylesheet(a)),
            a.AddRuntimeComponentMessageHandler("runtime", "alert", (a) => this._OnAlert(a));
            ...
            a.IsiOSWebView() && window.addEventListener("focusout", () => {
        ...
        Attach() {
            ...
            window.addEventListener("fullscreenerror", (a) => this._OnFullscreenError(a)),
            window.addEventListener("webkitfullscreenerror", (a) => this._OnFullscreenError(a)),
            window.addEventListener("mozfullscreenerror", (a) => this._OnFullscreenError(a)),
            window.addEventListener("keydown", (a) => this._OnKeyEvent("keydown", a)),
            window.addEventListener("keyup", (a) => this._OnKeyEvent("keyup", a)),
            window.addEventListener("dblclick", (a) => this._OnMouseEvent("dblclick", a, m)),
            window.addEventListener("wheel", (a) => this._OnMouseWheelEvent("wheel", a)),
            "undefined" == typeof PointerEvent ? (window.addEventListener("mousedown", (a) => this._OnMouseEventAsPointer("pointerdown", a)),
            window.addEventListener("mousemove", (a) => this._OnMouseEventAsPointer("pointermove", a)),
            window.addEventListener("mouseup", (a) => this._OnMouseEventAsPointer("pointerup", a)),
            window.addEventListener("touchstart", (a) => this._OnTouchEvent("pointerdown", a)),
            window.addEventListener("touchmove", (a) => this._OnTouchEvent("pointermove", a)),
            window.addEventListener("touchend", (a) => this._OnTouchEvent("pointerup", a)),
            window.addEventListener("touchcancel", (a) => this._OnTouchEvent("pointercancel", a))) : (window.addEventListener("pointerdown", (a) => this._OnPointerEvent("pointerdown", a)),
            ...
            window.addEventListener("pointerrawupdate", (a) => this._OnPointerRawUpdate(a))) : window.addEventListener("pointermove", (a) => this._OnPointerEvent("pointermove", a)),
            window.addEventListener("pointerup", (a) => this._OnPointerEvent("pointerup", a)),
            window.addEventListener("pointercancel", (a) => this._OnPointerEvent("pointercancel", a)));
        ...
        _OnSimulatedResize(a, b, c) {
            ...
            this._simulatedResizeTimerId = -1,
            d != a || e != b ? this._PostRuntimeEvent("window-resize", {
                "innerWidth": d,
                "innerHeight": e,
                "devicePixelRatio": window.devicePixelRatio
        ...
        _TrySetTargetOrientation() {
            ...
            if (screen["orientation"] && screen["orientation"]["lock"])
                screen["orientation"]["lock"](a).catch( (a) => console.warn("[Construct 3] Failed to lock orientation: ", a));
            else
                try {
                    let b = !1;
        ...
        _OnMouseEvent(b, c, d) {
            a(c) || ("mousedown" === b && window !== window.top && window.focus(),
        ...
        _OnMouseEventAsPointer(b, c) {
            ...
            "pointerdown" === b && 0 !== d ? b = "pointermove" : "pointerup" == b && 0 !== c.buttons && (b = "pointermove"),
            this._PostToRuntimeMaybeSync(b, {
                "pointerId": 1,
                "pointerType": "mouse",
                "button": c.button,
        ...
        _OnPointerEvent(a, b) {
            ...
            let c = 0;
            if ("mouse" === b.pointerType && (c = this._mousePointerLastButtons),
            this._PostToRuntimeMaybeSync(a, {
            ...
            "mouse" === b.pointerType) {
                let c = "mousemove";
                "pointerdown" === a ? c = "mousedown" : "pointerup" == a && (c = "pointerup"),
...
"use strict";
{
    ...
    self.JobSchedulerDOM = class {
        constructor(b) {
            ...
            this._baseUrl = a ? a.substr(0, a.lastIndexOf("/") + 1) : b.GetBaseURL(),
...
"use strict";
{
    const a = class extends DOMHandler {
        constructor(a) {
            super(a, "browser"),
            this._exportType = "",
            this.AddRuntimeMessageHandler("get-initial-state", (a) => this._OnGetInitialState(a)),
            ...
            this.AddRuntimeMessageHandler("lock-orientation", (a) => this._OnLockOrientation(a)),
            ...
            this.AddRuntimeMessageHandler("request-fullscreen", (a) => this._OnRequestFullscreen(a)),
            ...
            "undefined" != typeof Windows && Windows["UI"]["Core"]["SystemNavigationManager"]["getForCurrentView"]().addEventListener("backrequested", (a) => this._OnWin10BackRequested(a))
        }
        ...
        _OnLockOrientation(a) {
            ...
            if (screen["orientation"] && screen["orientation"]["lock"])
                screen["orientation"]["lock"](b).catch( (a) => console.warn("[Construct 3] Failed to lock orientation: ", a));
            else
                try {
                    let a = !1;
    ...
    const b = class extends DOMHandler {
        ...
        _UnblockAudioContext() {
            if (!this._hasUnblocked) {
                ...
                c["start"](0),
                "running" === a["state"] && (this._hasUnblocked = !0,
        ...
        _ReconnectEffects(a) {
            ...
            for (const c of this.audioInstancesByTag(a))
                c.Reconnect(b);
        ...
        ReleaseInstancesForBuffer(b) {
            ...
            for (let d = 0, a = this._audioInstances.length; d < a; ++d) {
                ...
                this._audioInstances[c] = e,
                e.GetBuffer() === b ? e.Release() : ++c
            }
        ...
        *audioInstancesByTag(b) {
        ...
        async _GetAudioBuffer(a, b, c, d, e) {
            ...
            return this._audioBuffers.push(f),
            await f.Load(),
            f
        }
        async _GetAudioInstance(a, b, c, d, e) {
            ...
            return this._audioInstances.push(g),
            g
        }
        _AddPendingTag(a) {
        ...
        Tick() {
            for (const b of this._analysers)
                b.Tick();
        ...
        async _Play(a) {
            ...
            try {
                ...
                j ? (this._lastAudioInstance.SetPannerEnabled(!0),
                this._lastAudioInstance.SetPan(j["x"], j["y"], j["angle"], j["innerAngle"], j["outerAngle"], j["outerGain"]),
                j.hasOwnProperty("uid") && this._lastAudioInstance.SetUID(j["uid"])) : this._lastAudioInstance.SetPannerEnabled(!1),
        ...
        async _FadeVolume(a) {
            ...
            for (const f of this.audioInstancesByTag(b))
                f.FadeVolume(c, d, e);
            this._MaybeStartTicking()
        }
        _SetMasterVolume(a) {
        ...
        async _AddEffect(a) {
            ...
            let e;
            if ("filter" === b)
                e = new C3AudioFilterFX(this,...d);
            else if ("delay" === b)
                e = new C3AudioDelayFX(this,...d);
                ...
                e._SetBufferInfo(a["bufferOriginalUrl"], a["bufferUrl"], a["bufferType"])
            } else if ("flanger" === b)
                e = new C3AudioFlangerFX(this,...d);
            else if ("phaser" === b)
                e = new C3AudioPhaserFX(this,...d);
            else if ("gain" === b)
                e = new C3AudioGainFX(this,...d);
            else if ("tremolo" === b)
                e = new C3AudioTremoloFX(this,...d);
            else if ("ringmod" === b)
                e = new C3AudioRingModFX(this,...d);
            else if ("distortion" === b)
                e = new C3AudioDistortionFX(this,...d);
            else if ("compressor" === b)
                e = new C3AudioCompressorFX(this,...d);
            else if ("analyser" === b)
                e = new C3AudioAnalyserFX(this,...d);
            else
                throw new Error("invalid effect type");
            this.AddEffectForTag(c, e),
        ...
        _SetEffectParam(a) {
            ...
            !h || 0 > c || c >= h.length || (h[c].SetParam(d, e, f, g),
            this._PostUpdatedFxState())
        }
        _RemoveEffects(a) {
            ...
            if (c && c.length) {
                for (const a of c)
                    a.Release();
                this._effects.delete(b),
                this._ReconnectEffects(b)
            }
        }
        _AddAnalyser(a) {
        ...
        async _OnLoadState(a) {
            ...
            await Promise.all(d),
            await Promise.all(a["playing"].map( (a) => this._LoadAudioInstance(a, b))),
            this._MaybeStartTicking()
        }
...
self.C3AudioBuffer = class {
    ...
    static Create(a, b, c, d, e) {
        ...
        return e && f && a._SetHasAnySoftwareDecodedMusic(),
        !e || a.IsPlayMusicAsSound() || f ? new C3WebAudioBuffer(a,b,c,d,e,f) : new C3Html5AudioBuffer(a,b,c,d,e)
    }
    CreateInstance(a) {
...
self.C3Html5AudioBuffer = class extends C3AudioBuffer {
    ...
    IsLoaded() {
        ...
        return a && (this._reachedCanPlayThrough = !0),
        a || this._reachedCanPlayThrough
    }
    IsLoadedAndDecoded() {
...
"use strict";
{
    ...
    self.C3AudioInstance = class {
        ...
        GetDuration(a) {
            ...
            return a && (b /= this._playbackRate || .001),
            b
        }
        Play() {}
        Stop() {}
        ...
        SetPannerEnabled(a) {
            a = !!a;
            this._isPannerEnabled === a || (this._isPannerEnabled = a,
        ...
        SetPan(b, c, d, e, f, g) {
            this._isPannerEnabled && (this.SetPanXYA(b, c, d),
...
self.C3WebAudioInstance = class extends C3AudioInstance {
    ...
    _OnEnded(a) {
        this._isPaused || this._resumeMe || a.target !== this._activeSource || (this._hasPlaybackEnded = !0,
        this._isStopped = !0,
        this._instUid = -1,
        this._ReleaseBufferSource(),
        this._audioDomHandler.PostTrigger("ended", this._tag, this._aiId))
    ...
    GetPlaybackTime(a) {
        let b = 0;
        return b = this._isPaused ? this._resumePosition : this.GetCurrentTime() - this._startTime,
...
"use strict";
{
    ...
    class f {
        ...
        SetAudioParam(a, b, c, d) {
            if (a["cancelScheduledValues"](0),
            0 === d)
                return void (a["value"] = b);
            const e = this._audioContext["currentTime"];
            d += e,
            0 === c ? a["setValueAtTime"](b, d) : 1 === c ? (a["setValueAtTime"](a["value"], e),
            a["linearRampToValueAtTime"](b, d)) : 2 === c ? (a["setValueAtTime"](a["value"], e),
            a["exponentialRampToValueAtTime"](b, d)) : void 0
        }
        GetState() {
            return {
                "type": this._type,
    ...
    self.C3AudioFilterFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            0 === a ? (b = Math.max(Math.min(b / 100, 1), 0),
            this._params[5] = b,
            this.SetAudioParam(this._wetNode["gain"], b, c, d),
            this.SetAudioParam(this._dryNode["gain"], 1 - b, c, d)) : 1 === a ? (this._params[1] = b,
            this.SetAudioParam(this._filterNode["frequency"], b, c, d)) : 2 === a ? (this._params[2] = b,
            this.SetAudioParam(this._filterNode["detune"], b, c, d)) : 3 === a ? (this._params[3] = b,
            this.SetAudioParam(this._filterNode["Q"], b, c, d)) : 4 === a ? (this._params[4] = b,
            this.SetAudioParam(this._filterNode["gain"], b, c, d)) : void 0
        }
    }
    ,
    self.C3AudioDelayFX = class extends f {
        ...
        SetParam(a, c, d, e) {
            0 === a ? (c = Math.max(Math.min(c / 100, 1), 0),
            this._params[2] = c,
            this.SetAudioParam(this._wetNode["gain"], c, d, e),
            this.SetAudioParam(this._dryNode["gain"], 1 - c, d, e)) : 4 === a ? (this._params[1] = b(c),
            this.SetAudioParam(this._delayGainNode["gain"], b(c), d, e)) : 5 === a ? (this._params[0] = c,
            this.SetAudioParam(this._delayNode["delayTime"], c, d, e)) : void 0
        }
    }
    ,
    self.C3AudioConvolveFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            ...
            this._params[1] = b,
            this.SetAudioParam(this._wetNode["gain"], b, c, d),
            this.SetAudioParam(this._dryNode["gain"], 1 - b, c, d)) : void 0
        }
        ...
        GetState() {
            ...
            return a["bufferOriginalUrl"] = this._bufferOriginalUrl,
            a["bufferUrl"] = "",
    ...
    self.C3AudioFlangerFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            ...
            this.SetAudioParam(this._dryNode["gain"], 1 - b / 2, c, d)) : 6 === a ? (this._params[1] = b / 1e3,
            this.SetAudioParam(this._oscGainNode["gain"], b / 1e3, c, d)) : 7 === a ? (this._params[2] = b,
            this.SetAudioParam(this._oscNode["frequency"], b, c, d)) : 8 === a ? (this._params[3] = b / 100,
            this.SetAudioParam(this._feedbackNode["gain"], b / 100, c, d)) : void 0
        }
    }
    ,
    self.C3AudioPhaserFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            ...
            this._params[5] = b,
            this.SetAudioParam(this._wetNode["gain"], b / 2, c, d),
            this.SetAudioParam(this._dryNode["gain"], 1 - b / 2, c, d)) : 1 === a ? (this._params[0] = b,
            this.SetAudioParam(this._filterNode["frequency"], b, c, d)) : 2 === a ? (this._params[1] = b,
            this.SetAudioParam(this._filterNode["detune"], b, c, d)) : 3 === a ? (this._params[2] = b,
            this.SetAudioParam(this._filterNode["Q"], b, c, d)) : 6 === a ? (this._params[3] = b,
            this.SetAudioParam(this._oscGainNode["gain"], b, c, d)) : 7 === a ? (this._params[4] = b,
            this.SetAudioParam(this._oscNode["frequency"], b, c, d)) : void 0
        }
    }
    ,
    self.C3AudioGainFX = class extends f {
        ...
        SetParam(a, c, d, e) {
            4 === a ? (this._params[0] = b(c),
            this.SetAudioParam(this._node["gain"], b(c), d, e)) : void 0
        }
    }
    ,
    self.C3AudioTremoloFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            ...
            this.SetAudioParam(this._oscGainNode["gain"]["value"], b / 2, c, d)) : 7 === a ? (this._params[0] = b,
            this.SetAudioParam(this._oscNode["frequency"], b, c, d)) : void 0
        }
    }
    ,
    self.C3AudioRingModFX = class extends f {
        ...
        SetParam(a, b, c, d) {
            ...
            this._params[1] = b,
            this.SetAudioParam(this._wetNode["gain"], b, c, d),
            this.SetAudioParam(this._dryNode["gain"], 1 - b, c, d)) : 7 === a ? (this._params[0] = b,
            this.SetAudioParam(this._oscNode["frequency"], b, c, d)) : void 0
        }
    }
    ,
...
"use strict";
{
    ...
    const c = class extends DOMElementHandler {
        constructor(a) {
            super(a, "text-input"),
            this.AddDOMElementMessageHandler("scroll-to-bottom", (a) => this._OnScrollToBottom(a))
        }
        CreateElement(c, d) {
            let e;
            const f = d["type"];
            return "textarea" === f ? (e = document.createElement("textarea"),
            e.style.resize = "none") : (e = document.createElement("input"),
            e.type = f),
            ...
            e.addEventListener("click", (a) => {
                a.stopPropagation(),
                this._PostToRuntimeElementMaybeSync("click", c)
            }
            ),
            ...
            e.addEventListener("input", () => this.PostToRuntimeElement("change", c, {
                "text": e.value
            })),
            e.id = d["id"],
